...
<!-- - Odd result: % registered was >100% in a lot of places. We used the voter file for the numerator and the Maryland-adjusted 2020 census adult population counts for the denominator. Perhaps we should’ve used the adjusted total population counts as the denominator since some 16- and 17-year-olds are in the voter file (less than 1% of registered voters though). Anyway, means that potentially we shouldn’t be overconfident in our numbers and it may be more beneficial to look for qualitative/relative trends. -->
