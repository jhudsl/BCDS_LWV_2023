...
# urls for the data
data_urls <- list()
data_urls[["adjusted_population_data_2020"]] <- "https://planning.maryland.gov/Redistricting/Documents/2020data/GreenReport.pdf"
...
data_paths <- list()
data_paths[["adjusted_population_data_2020"]] <- paste0(data_dirs[["adjusted_population_data_2020"]], "adjusted_population_data_2020.pdf")
